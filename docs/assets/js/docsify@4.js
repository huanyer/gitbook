!(function() {
  ...
  function B(e) {
    ...
    q || ((e = x('div')).classList.add('progress'), o(v, e), (q = e)),
      (t = i
        ? 80 < (t = parseInt(q.style.width || 0, 10) + i) ? 80 : t
        : Math.floor(n / r * 100)),
      (q.style.opacity = 1),
  ...
  var ge = ((function(e, t, n) {
    ...
    },
    {
      ...
      value: function(e, t) {
        return (
          (this.events[e] = this.events[e] || []), this.events[e].push(t), this
        );
      },
    },
    {
  ...
  function Tt(e, t) {
    ...
    return '//' === t.substring(0, 2)
      ? n ? t : e.replace(St, '$1') + t
      : '/' === t.charAt(0) ? (n ? t : e.replace(At, '$1') + t) : e + t;
  }
  function Et(e, t, n) {
    var r = e.length;
    if (0 === r) return '';
    ...
    (En.prototype._initRenderer = function() {
      ...
      return (
        ...
        (i.paragraph = { renderer: e }.renderer.paragraph = function(e) {
          e = /^!&gt;/.test(e)
            ? hn('tip', e)
            : /^\?&gt;/.test(e) ? hn('warn', e) : '<p>' + e + '</p>';
          return e;
        }),
        (i.image = ((r = (n = { renderer: e, contentBase: r, router: a })
          .renderer),
        (u = n.contentBase),
        (p = n.router),
